...
### Create a Stored Table Not Shown in the Knitted Document

Table should contain the total number of purple urchins observed by site and year.
...
ggplot(data = site_num, 
  ...
  theme_gray() +
  theme(legend.key.size = unit(0.17, 'cm')) +
